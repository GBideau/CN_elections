...
Ce document présente le détail des analyses réalisées autour de la question des liens entre orientations politiques et communes nouvelles. Les objectifs et résulats de l'étude seront développés dans un article, en cours de rédaction. **Ce script est un _document de travail_ qui a pour but, dans une logique de science ouverte, de permettre la transparence, la vérification et la reproductibilité des analyses proposées.**
